...
// Grab classes from the OGL global (loaded via the script tag)
// const { Renderer, Program, Triangle, Mesh } = OGL;

const OGL_NS = window.ogl || window.OGL;
if (!OGL_NS) {
  console.error("OGL not found. Make sure the OGL script tag loads before this script.");
}
  ...
  return (
    <div className="hero-section">
      ...
      <div className="hero-content">
        ...
        <p>Creative tagline goes here</p>
      </div>
    </div>
  );
}
