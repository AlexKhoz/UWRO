    ...
    React.useEffect(() => {
        ...
        const render = (currentTime) => {
            ...
            if (rotateOnHover && effectiveHover > 0.5) {
                currentRotation += dt * rotationSpeed;
            }
            ...
            gl.uniform1f(uniformLocations.hover, currentHover);
            gl.uniform1f(uniformLocations.rot, currentRotation);
            gl.uniform1f(uniformLocations.hoverIntensity, hoverIntensity);
...
// Render the orb
ReactDOM.render(
    React.createElement(Orb, orbSettings), 
